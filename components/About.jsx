    ...
    <>
      <article className="about active ">
        ...
        <section className="about-text">
          <p>
            I’m a frontend developer with over 3 years of going  hands-on experience
            in creating responsive and engaging user interfaces. Recently, I’ve
            expanded my skill set to include WordPress with WooCommerce, where I
            have 5 months of experience in crafting customized websites and
            e-commerce solutions. Currently, I’m diving into full-stack
            development with the MERN stack and have already completed three
            projects, applying my learning to build scalable, dynamic
            applications.
          </p>
          <p>
          ...
          <ul className="service-list">
            ...
            <li className="service-item">
              ...
              <div className="service-content-box">
                ...
                <p className="service-item-text">
                  As a stunning desinger i create Mobile optimize professioanl websites.
                </p>
              </div>
            </li>
            <li className="service-item">
